...
<template>
  <div class="text-gray-700 w-1/2 mx-auto flex flex-col items-center">
    <h1 class="my-12 text-center text-lg font-medium">
    ...
    >
      <button @click="$emit('restartQuiz')" class="flex items-center">
